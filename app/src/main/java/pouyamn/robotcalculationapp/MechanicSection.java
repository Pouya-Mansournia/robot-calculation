...
public class MechanicSection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Calc_BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SIN = (float) (Math.sin(MI * 0.0174533) * 9.81);   // to radian
                TORQUE = (float) ((100 / TE) * ((DA + SIN) * (TM * RW)) / NM);
                ANGULARVOLICITY = (float) ((RV / RW) * (9.54929)); // rad/s to rpm

                calctorque.setText(String.format("Torque per Motor : "+"%.4f"+" N.m", TORQUE));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "1 (N.m) = 10.1971 (kgf-cm) \n1 (RPM) = 0.1047 (Rad/S)", Snackbar.LENGTH_LONG)
